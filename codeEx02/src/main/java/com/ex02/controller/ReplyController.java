...
import com.ex02.service.ReplyService;
...
public class ReplyController {
	 ...
	 * log.info("pages getList ...page :"+page+"bno:" + bno );
	 * 
	 * Criteria cri = new Criteria(page, 10); return new
	...
	@PreAuthorize("principal.username == #vo.replyer")
	@RequestMapping(value = "/{rno}", consumes = "application/json" ,  method = { RequestMethod.PUT, RequestMethod.PATCH} , produces = {MediaType.TEXT_PLAIN_VALUE}  )
	public ResponseEntity<String> modify(@RequestBody ReplyVO vo, @PathVariable("rno") Long rno){
		...
		return updateCount == 1 ? 
			new ResponseEntity<String>("Suceess", HttpStatus.OK) : new ResponseEntity<String>(HttpStatus.INTERNAL_SERVER_ERROR);
	}
